...
- **PostgreSQL Database**: 1GB storage, 30-day limit
...
Ensure all the deployment files are committed and pushed:
...
### 2. PostgreSQL 30-Day Expiration
- Free PostgreSQL expires after 30 days
- Set a reminder to recreate the database before expiration
- For production, upgrade to paid PostgreSQL ($7/month)
...
- PostgreSQL: $0/month (1GB, 30-day limit)
- Redis: $0/month (25MB)
- **Total: $0/month**
