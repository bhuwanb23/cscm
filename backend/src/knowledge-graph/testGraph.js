...
async function testKnowledgeGraph() {
  ...
  try {
    ...
    console.log(
      '  ✓ Created relationship: NYC Flagship Store procures from Tech Electronics Distributors'
    );
    ...
    console.log(
      '  ✓ Created relationship: Apple iPhone 15 supplied by Tech Electronics Distributors'
    );
    ...
    console.log(
      `  ✓ Serialized graph: ${serialized.nodes.length} nodes, ${serialized.edges.length} edges`
    );
