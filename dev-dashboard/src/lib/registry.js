...
export const AI_DOMAINS = [
  ...
  },
  {
    ...
    sample: { endpoint: '/demand-planning/plan', method: 'POST', body: { storeId: 'store-1', horizonWeeks: 4 } },
  },
  {
    key: 'inventory-opt',
  ...
  },
  {
    ...
    sample: { endpoint: '/nlp/summarize', method: 'POST', body: { text: 'Weekly demand is trending up 12% in the north region...' } },
  },
  {
    key: 'kg',
  ...
  },
  {
    ...
    sample: { endpoint: '/vision/inspect', method: 'POST', body: { imageUrl: 'https://example.com/shelf.jpg' } },
  },
  {
    key: 'learning',
    ...
    sample: { endpoint: '/learning/status', method: 'GET', body: null },
  },
  {
    key: 'uncertainty',
    ...
    sample: { endpoint: '/uncertainty/estimate', method: 'POST', body: { storeId: 'store-1' } },
  },
  {
    key: 'monitoring',
    ...
    sample: { endpoint: '/monitoring/health', method: 'GET', body: null },
  },
  {
    key: 'digital-twin',
    title: 'Digital Twin',
    ...
    sample: { endpoint: '/digital-twin/state', method: 'GET', body: null },
  },
  {
    key: 'coordination',
    ...
    sample: { endpoint: '/coordination/status', method: 'GET', body: null },
  },
  {
    key: 'explain',
